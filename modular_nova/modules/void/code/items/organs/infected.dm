#define ORGAN_N4_CORRUPTED "organ_n4_corrupted"
#define N4_TRAITS "n4_virus_traits"
...
/obj/item/organ/heart/n4/on_life(seconds_per_tick, times_fired)
	...
	if(COOLDOWN_FINISHED(src, damage_cooldown))
		...
		owner.apply_damage(rand(2, 4), wound_clothing = FALSE)
...
/obj/item/organ/heart/n4/Initialize(mapload)
	. = ..()
	ADD_TRAIT(src, ORGAN_N4_CORRUPTED, N4_TRAITS)
...
/obj/item/organ/liver/n4/Initialize(mapload)
	. = ..()
	ADD_TRAIT(src, ORGAN_N4_CORRUPTED, N4_TRAITS)
...
/obj/item/organ/lungs/n4/Initialize(mapload)
	. = ..()
	ADD_TRAIT(src, ORGAN_N4_CORRUPTED, N4_TRAITS)
...
/obj/item/organ/stomach/n4/Initialize(mapload)
	. = ..()
	ADD_TRAIT(src, ORGAN_N4_CORRUPTED, N4_TRAITS)
